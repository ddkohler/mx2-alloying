...
def run(save):
    ...
    # x20 = root.wt.open(data_dir / "reflection_microspectroscopy" / "reflection_20x.wt5")

    dx20 = root.reflection.x20
    dx20.transform("energy", "ydist")
    dx20.contrast.clip(-0.35, 0.35)

    img = root.reflection.x100_image
    ...
    x0 = 0
    pl = root.pl.proc.chop("energy", "y", at={"x":[x0, "um"]})[0]
